...
IROCK_MODBUS_REGISTERS: List[Dict[str, Union[Version, Dict[str, Union[str, int]]]]] = [
...
IROCK_MODBUS_CELL_REGISTERS: List[Dict[str, Union[Version, int, Dict[str, Union[str, int]]]]] = [
